...
//     version 1.14.2
//     from Assets/TPS_Locomotion_and_Combat_Bundle/01_Settings/InputActions/BundleInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/TPS_Locomotion_and_Combat_Bundle/01_Settings/InputActions/BundleInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @BundleInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @BundleInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""BundleInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@BundleInputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, BundleInputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, BundleInputActions.UI.Disable() has not been called.");
    }
    ...
    {
        private @BundleInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@BundleInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@BundleInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
